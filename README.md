...
* 💡 For patching sorted N-Quad files use [Scaseco/nqpatch-posix](https://github.com/Scaseco/nqpatch-posix) with ~20x the throughput of uncompressed data (~400MB/s).
